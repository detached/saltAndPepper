...
export default function ChangePasswordForm() {
    ...
    const [passwordChangeState, setPasswordChangeState] = useState(OperationState.NONE);
    ...
    const changePassword = useCallback(e => {
        ...
        SaltAndPepper.changePassword(new ChangePasswordRequest(oldPassword, newPassword))
            .then(() => {
    ...
    }, [isLoading, setIsLoading, newPassword, oldPassword, setPasswordChangeState, setErrorReason])
    ...
    return <>
        ...
        <form className="pure-form pure-form-aligned" onSubmit={e => changePassword(e)}>
