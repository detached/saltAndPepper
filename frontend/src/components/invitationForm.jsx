...
export default function InvitationForm() {
    ...
    const createInvitationLink = useCallback((e) => {
        e.preventDefault();
        if (isLoading) {
            return
        }
    ...
    return <>
        ...
        <form className="pure-form pure-form-aligned" onSubmit={e => createInvitationLink(e)}>
            <div className="pure-control-group">
                <fieldset>
                    <input className="pure-button" type="submit" id="createInvitation" name="createInvitation"
                           value={t("profile.createInvitation")} disabled={invitationLink !== ""}/>
                </fieldset>
                {invitationLink !== "" ?
                    <fieldset>
