...
export default function Search() {
    ...
    const switchPage = useCallback((pageNumber) => {
        dispatchSearchRequest({ type: SearchRequestActions.SET_PAGE_NUMBER, pageNumber: pageNumber });
        setDoSearch(true);
    ...
    return (
        <div className="pure-g">
            <div className="pure-u-1-1">
                <form className="pure-form search-mask" onSubmit={(e) => submitSearchQuery(e)}>
                    <input
                        ...
                        onChange={(e) => dispatchSearchRequest({ type: SearchRequestActions.SET_QUERY, searchQuery: e.target.value})}
                    />
                    <input
                        id="submit"
                        type="submit"
            ...
            <div className="pure-u-1-1">
                <RecipeList page={searchResult.page} listItems={searchResult.items} setPage={switchPage}/>
            </div>
        </div>
    );
}
